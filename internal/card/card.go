...
func BuildFromSections(id, goal string, source types.SourceRef, sections Sections, generator string, createdAt time.Time) (types.Handoff, error) {
...
func render(handoff types.Handoff, sections Sections, reviewDraft bool) string {
	...
	fmt.Fprintf(&output, "title: %s\ncreated_at: %s\ngenerator: %s\n---\n\n", yamlString(title), handoff.CreatedAt.Format(time.RFC3339), yamlString(handoff.Generator))
